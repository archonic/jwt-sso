...
class ItglueSessionController < ApplicationController
  ...
  def create
    default_return = "https://#{ITGLUE_SUBDOMAIN}.staging.itglue.com" # http://#{ITGLUE_SUBDOMAIN}.itglue.localhost:3000
  ...
  def itglue_sso_url(payload)
    url = "https://#{ITGLUE_SUBDOMAIN}.staging.itglue.com/access/jwt?jwt=#{payload}" # http://#{ITGLUE_SUBDOMAIN}.itglue.localhost:3000/access/jwt?jwt=#{payload}
